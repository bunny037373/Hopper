...
client.once('ready', async () => {
    ...
    client.user.setPresence({ 
        activities: [{ name: 'EXPLODING QUICK TAP BECAUSE ITS SUCH AN EXPLODING CUBE GAME WITH NONESENSE AND STUPID CUBES AND 2.99$ APP CALLED COZMO ROBOT THAT ARE SO STUPID I DONT KNOW WHY IT EVEN IS A THING SO PLESAE DESTERY THE COZMO APP RIGHT NOW OR I WILL EAT HIS CUBES AND HE WILL BE SAD AND I WILL ALSO EAT THE CHARGER AND HE WILL NEVER LIVE AGAIN HAHAHAHAHA!', type: 0 }], 
        status: 'online' 
    });
