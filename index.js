...
const {
  ...
  PermissionsBitField,
  ThreadChannel,
  EmbedBuilder // NEW: Used for text-based rank/leaderboard output
} = require('discord.js');
...
// NOTE: All Canvacord imports and initialization were removed as requested.
